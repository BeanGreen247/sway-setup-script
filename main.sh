...
cd .config/waybar/
wget -O /home/$user/.config/ https://raw.githubusercontent.com/BeanGreen247/sway-setup-script/main/waybar/config
wget -O /home/$user/.config/ https://raw.githubusercontent.com/BeanGreen247/sway-setup-script/main/waybar/style.css
